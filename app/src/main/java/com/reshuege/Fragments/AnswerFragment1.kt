...
import com.reshuege.FirstPoint
import com.reshuege.R
import com.reshuege.utils.Masker.setMasked
import com.reshuege.utils.MultipartUtility
...
class AnswerFragment1 : Fragment() {
    ...
    internal fun initializePoints() {
        ...
        pointObj = FirstPoint(subject_prefix.toString(), requireContext())
    }
