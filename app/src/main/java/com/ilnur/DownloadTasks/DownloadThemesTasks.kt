...
class DownloadThemesTasks(internal var context: Context, internal var subject_prefix: String,
    ...
    public fun setAdapter(adapter: ThemesArrayAdapter?){
    ...
    override fun doInBackground(vararg strings: String): ArrayList<JSONObject> {
        ...
        try {
            ...
            //val fold
            //val folder = File(Environment.getExternalStorageDirectory().toString() + "/RESHUEGE/Pictures/" + subject_prefix + theme)
