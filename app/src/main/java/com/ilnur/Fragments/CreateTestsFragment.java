...
import com.ilnur.TreeBinders.ChildBinder;
import com.ilnur.TreeBinders.ParentBinder;
...
public class CreateTestsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.setCategories(new Categories(new ArrayList<>(), new ArrayList<>(), new ArrayList<>()));
        rv.setAdapter(adapter);*/
        /*rv.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            @Override
    ...
    private class LoadCategory extends AsyncTask<Void, Void, Categories> {
        ...
        protected Categories doInBackground(Void... voids) {
            ...
            System.out.println(el.parent().text());*/
                    Element input = tr.select("td").last(); //input
                    //System.out.println(input.select("td > input").attr("id")); // probcat2/3 data: value:number
        ...
        protected void onPostExecute(Categories categories) {
            ...
            //adapter = new ExpandableListAdapter(getContext(), categories);
            //rv.setAdapter(adapter);
            if (categories == null)
                Log.d("CATS", "NULL");
