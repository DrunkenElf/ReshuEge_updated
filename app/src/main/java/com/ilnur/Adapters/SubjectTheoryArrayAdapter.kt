...
import com.ilnur.DownloadTasks.DownloadHandbook1
import com.ilnur.Fragments.SubjectsTheoryFragment
import com.ilnur.R
...
class SubjectTheoryArrayAdapter(context: Context, private val values: Array<String>,
    ...
    private val ada: SubjectTheoryArrayAdapter
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        //String[] subjects = context.getResources().getStringArray(R.array.subjects_handbook);
        ...
        try {
            val rootnames = MyDB.getRootNames(values[position])
            ...
            //subjectPrefix.setText(subjects_prefix[position]);
