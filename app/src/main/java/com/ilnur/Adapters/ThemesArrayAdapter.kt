...
class ThemesArrayAdapter(context: Context, private val values: Array<String?>, private val subject_prefix: String) : ArrayAdapter<String>(context, R.layout.themes_list_item, values) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val qdbHelper = QuestionsDataBaseHelper(context, subject_prefix + "_" + themeId)
        val displaymetrics = context.resources.displayMetrics

        if (qdbHelper.checkTable(subject_prefix + "_" + themeId)) {
